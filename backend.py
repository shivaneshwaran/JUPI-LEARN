...
def send_mail(address,name):
	...
	try:
		...
		mBody = "Hello {} to JUPI Learning, a groundbreaking platform dedicated to providing free, high-quality education to all.\
			Your account has been created with username as your email address.\nSign in to start your journey\nhttps://jupilearning.app".format(name)
		mText = """\
From: {}
Subject: {}
